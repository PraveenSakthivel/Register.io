 ...
 * @const
 */
proto.dbRequests.Class.repeatedFields_ = [6,8,9];
...
proto.dbRequests.Class.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    codesList: (f = jspb.Message.getRepeatedField(msg, 6)) == null ? undefined : f,
    synopsis: jspb.Message.getFieldWithDefault(msg, 7, ""),
    booksList: (f = jspb.Message.getRepeatedField(msg, 8)) == null ? undefined : f,
...
proto.dbRequests.Class.prototype.getSectionsList = function() {
  return /** @type{!Array<!proto.dbRequests.Section>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.dbRequests.Section, 9));
};
...
proto.dbRequests.Class.prototype.addSections = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 9, opt_value, proto.dbRequests.Section, opt_index);
};
